...
type Domain struct {
	...
	AuthWebhookSecret     string     `json:"-"`
	AuthWebhookVerified   bool       `json:"auth_webhook_verified"`
	AuthWebhookVerifiedAt *time.Time `json:"auth_webhook_verified_at,omitempty"`
	...
	RelayUseTLS           bool       `json:"relay_use_tls"`
	RelayTLSSkipVerify    bool       `json:"relay_tls_skip_verify"`
...
type OrganizationRepository interface {
	...
	GetOrgByName(name string) (*Organization, error)
